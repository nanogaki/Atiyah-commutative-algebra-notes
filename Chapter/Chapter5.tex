...
\begin{proposition*}[\textcolor{red}{Noether normalization lemma}]\label{noethernormalization}
	Let $k$ be a field and let $A\neq0$ be a finitely generated $k$-algebra. Then there exist elements $y_1,\cdots,y_r\in A$ which are algebraically independent over $k$ and such that $A$ is integral, and therefore finite over $k[y_1,\cdots,y_r]$.
\end{proposition*}
...
\begin{definition}
	A subset of a topological space $X$ is \textcolor{orange}{locally closed} if it is the intersection of an open set and a closed set.
	
	A subset $X_0$ satisfying the following equivalent conditions is said to be \textcolor{orange}{very dense} in $X$:
	\begin{enumerate}[label=\textup{(\arabic*)}]
		...
		\item The mapping $U\mapsto U\cap X_0$ of the collection of open sets of $X$ on to the collection of open sets of $X_0$ is bijective.
	\end{enumerate}
\end{definition}
