...
\begin{exercise}\label{ex9.6}
	...
	By \Cref{ex3.19.5}, $\operatorname{Supp}(M)=V(\operatorname{Ann}(M))$. From \Cref{9.1} and \Cref{9.3.2}, $\operatorname{Ann}(M)=\mathfrak{p}_1^{n_1}\cdots\mathfrak{p}_k^{n_k}$. Use $\dim A=1$ to prove that $V(\operatorname{Ann}(M))$ is finite.
\end{exercise}
