...
\begin{exercise}\label{ex6.7}
	Let $\Sigma$ be the collection of closed subsets of $X$ which are not finite union of irreducible closed subspaces. Then $\Sigma$ has minimal element $X_0$. Prove that $X_0$ cannot be either irreducible or reducible.
\end{exercise}
