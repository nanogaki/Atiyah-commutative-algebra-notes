...
\begin{exercise}\label{ex8.6}
 	...
 	\begin{itemize}
 		\item \textit{If $A$ is an Artinian local ring, $\mathfrak{m}$ its only maximal ideal. Then every ideal in $A$ is $\mathfrak{m}$-primary.}\\ Radical is the intersection of the only prime ideal. Then use \Cref{4.2}.
